...
import { CareerAverageBat, CareerAverageBow, Player } from "../Types/types";
import {
  API_BASE,
  API_URL_CAVG_BAT,
  API_URL_CAVG_BOW,
  ...
  return (
    <>
      ...
      <div className="container mt-3">
        ...
        {playerA.roll_id === "BAT" && (
          <CompareBatsmen
            careerAvgA_Bat={careerAvgA_Bat}
            careerAvgB_Bat={careerAvgB_Bat as CareerAverageBat}
          />
        )}
        {playerA.roll_id === "BOW" && (
          <CompareBowlers
            careerAvgA_Bow={careerAvgA_Bow}
            careerAvgB_Bow={careerAvgB_Bow as CareerAverageBow}
          />
        )}
        {playerA.roll_id === "ALL" && playerB.roll_id === "BAT" && (
          <CompareBatsmen
            careerAvgA_Bat={careerAvgA_Bat}
            careerAvgB_Bat={careerAvgB_Bat as CareerAverageBat}
          />
        )}
        {playerA.roll_id === "ALL" && playerB.roll_id === "BOW" && (
          <CompareBowlers
            careerAvgA_Bow={careerAvgA_Bow}
            careerAvgB_Bow={careerAvgB_Bow as CareerAverageBow}
          />
        )}
        {playerA.roll_id === "ALL" && playerB.roll_id === "ALL" && (
          <CompareAllrounders
            careerAvgA_Bat={careerAvgA_Bat}
            careerAvgA_Bow={careerAvgA_Bow}
            careerAvgB_Bat={careerAvgB_Bat as CareerAverageBat}
