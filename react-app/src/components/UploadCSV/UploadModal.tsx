...
import { API_BASE, API_URL_CSV_DOWNLOAD, API_URL_CSV_UPLOAD } from '../API/api';
...
const UploadModal: React.FC<UploadModalProps> = (props) => {
    ...
    const handleUpload = () => {
        ...
        if (!file) {
            ...
            fetch(API_BASE + API_URL_CSV_UPLOAD, {
                method: 'POST',
                body: formData,
            })
                .then((response) => {
    ...
    const downloadData = async () => {
        try {
            const response = await fetch(API_BASE + API_URL_CSV_DOWNLOAD);
